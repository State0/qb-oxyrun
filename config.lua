...
-- Oxy runs.
Config.StartOxyPayment = 2000 -- How much you pay at the start to start the run

Config.RunAmount = math.random(10,15) -- How many drop offs the player does before it automatixally stops.

Config.Payment = math.random(100, 200) -- How much you get paid when RN Jesus doesnt give you oxy, divided by 2 for when it does.
...
Config.BigRewarditem = "joint" -- Put a rare item here which will have 50% chance of being given on the run.
